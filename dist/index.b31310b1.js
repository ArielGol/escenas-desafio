...
parcelHelpers.export(exports, "findAndProcessLinks", ()=>findAndProcessLinks
);
...
function findAndProcessLinks(container = document) {
...
var _email = require("../components/sent/email");
var _ = require(".");
var _email1 = require("../components/inbox/email");
function handleRoute(route) {
    const contenedorEl = document.querySelector(".container");
    const routes = [
        {
            path: /\/inbox/,
            handler: _inbox.inboxComponent
        },
        {
            path: /\/sent/,
            handler: _sent.sentComponent
        },
        {
            path: /inbox\/./,
            handler: _email1.inboxEmailComponent
        },
        {
            path: /sent\/./,
            handler: _email.sentEmailComponent
        }
    ];
    for (const r of routes)if (r.path.test(route)) {
        const el = r.handler();
        if (contenedorEl.firstChild) contenedorEl.firstChild.remove();
        contenedorEl.appendChild(el);
        _.findAndProcessLinks(el);
    }
}

},{"../components/inbox/inbox":"c69Fu","../components/sent/sent":"iqoXn","../components/sent/email":"c0eyM",".":"4aleK","../components/inbox/email":"1WA2t","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"c69Fu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inboxComponent", ()=>inboxComponent
);
...
},{}],"iqoXn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sentComponent", ()=>sentComponent
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"c0eyM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sentEmailComponent", ()=>sentEmailComponent
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"1WA2t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "inboxEmailComponent", ()=>inboxEmailComponent
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8uBhv","4aleK"], "4aleK", "parcelRequired1a1")
